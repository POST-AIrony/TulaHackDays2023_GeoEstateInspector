...
def analyze_tiff(path_to_tif, path_to_save_folder, path_to_output_zip_folder,  path_to_model, path_to_land_map):
    ...
    path_to_zip = archive_and_delete_files(unique_name, path_to_save_folder, path_to_output_zip_folder)
    return path_to_zip
